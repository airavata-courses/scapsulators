...
function Index() {
    ...
    var data = JSON.stringify({"token":userDetails.accessToken});
    ...
    .then(function (response) {
        ...
        else {alert('Please set zoom to 75%')}
  ...
  <div>
      ...
      <Routes>
          ...
          <Route path="/nexrad" element={<HomePage/>} />
          <Route path="/nasa" element={<NasaHome/>} />
